...
Hebbian learning is one of the oldest and most biologically grounded learning rules. Unlike backpropagation, it is **local** — a synapse updates based only on the activity of the two neurons it connects, with no global error signal required. This module implements and analyses:
